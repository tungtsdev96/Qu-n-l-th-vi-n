...
public class AccountInfo extends javax.swing.JPanel {
    ...
    public void setInfo(){
        Account.setText(CreateNewCardFrame.taikhoan.getUsername());
        FullName.setText(CreateNewCardFrame.taikhoan.getName());
        Email.setText(CreateNewCardFrame.taikhoan.getEmail());
        Gender.setText(CreateNewCardFrame.taikhoan.isIsMale()?"Nam":"Nữ");
        SDT.setText(CreateNewCardFrame.taikhoan.getPhone());
    }
