...
import model.Book;
import book.bookdetail.view.BookDetailForm;
...
public class HomeForm extends javax.swing.JPanel {
    ...
    public void loadBook() throws ClassNotFoundException, SQLException{
        books = BookController.getInstance().getListBook();
       genTableBook(books);
    }
    ...
    private void genTableBook(ArrayList<Book> books){
        ...
        for (Book b : books){
            model.addRow(new Object[]{
                b.getIdBook(),
                b.getTitleBook(),
                b.getPublisher().getNamePublisher(),
                b.getNameAuthor()
            });    
        }
    ...
    private void btnSeeDetailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeeDetailActionPerformed
        ...
        if (i != -1){
            BookDetailForm frame = new BookDetailForm(books.get(i).getIdBook());
    ...
    private void searchBook() throws ClassNotFoundException, SQLException {
        if (tfSearchBook.getText().toString().isEmpty()){
            ...
            ArrayList<Book> arr = BookController.getInstance().searchBook(key);
            genTableBook(arr);
        }
    }
